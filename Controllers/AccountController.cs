        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await WriteLogAsync("PostgreSQL Логин:" + user.UserName + "@example.com Пароль:" + model.Password + " База данных: " + user.UserName.ToLower() + "db", pathInfoDB);
                    await WriteLogAsync("PgAdminSQL Логин:" + user.UserName + "@example.com Пароль:" + model.Password, pathInfoDB);
                    await WriteLogAsync("MySQL Логин:" + user.UserName + " Пароль:" + model.Password + " База данных: " + user.UserName + "db", pathInfoDB );
                    await WriteLogAsync("PHPMyAdmin Логин:" + user.UserName + " Пароль:" + model.Password, pathInfoDB);
